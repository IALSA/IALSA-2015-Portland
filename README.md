...
## Results  
* Basic model look-up is now available. Update repository, load project in RStudio, and open [`./scripts/basic-model-lookup.R`](/blob/master/scripts/basic-model-lookup.R)
