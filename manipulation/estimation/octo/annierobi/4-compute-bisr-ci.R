...
# ---- load-globals ---------------------
path_input <- "./data/shared/derived/dem-criteria/catalog-3.rds"
path_output <- "./data/shared/derived/dem-criteria/catalog-4.rds"
...
variables_part_1 <- c(
  ...
  ,"condition"   # one of the three condition for sample inclusion
  ,"model_name"  # unique id in a condition
)
