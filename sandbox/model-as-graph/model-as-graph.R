...
#   data         = ds[,subset_variables],
#   id.vars      = stem_vars,
#   measure.vars = core_vars
# )
#
...
# )
# saveRDS(d, "./data/unshared/temp.rds")

# ---- get-models ---------------------------------
ds0 <- readRDS("./data/unshared/temp.rds")
# each row of d is a model (actually, four rows: est, se, wald, pval, only we use est)
ds <- ds0 %>% dplyr::filter(index=="est", model_number=="b1")
...
model <- ds %>%
  ...
  dplyr::select_(
    "study_name","subgroup","model_type","process_a", "process_b",
    "a_GAMMA_00", "a_GAMMA_10", "b_GAMMA_10", "b_GAMMA_00",
    "a_GAMMA_01", "a_GAMMA_11", "b_GAMMA_11", "b_GAMMA_01",
    "a_GAMMA_02", "a_GAMMA_12", "b_GAMMA_12", "b_GAMMA_02",
    "a_GAMMA_03", "a_GAMMA_13", "b_GAMMA_13", "b_GAMMA_03",
...
F# d <- d  %>% dplyr::select_("study_name","model_number","subgroup","model_type",
#                            "process_a", "process_b", "index",
#                            #  "R_IAIB", "R_SASB",
#                            # "ab_TAU_00","ab_TAU_11", "p_a", "p_b",
#                            # "aa_TAU_00", "aa_TAU_11", "bb_TAU_11","bb_TAU_00",
