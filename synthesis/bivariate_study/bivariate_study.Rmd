---
title: Bivariate Outcomes -- Study-Specific
output:
  html_document:
    keep_md: yes
    toc: yes
...
read_chunk("./synthesis/bivariate_study/bivariate_study.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
# Tables
```{r tables, echo=echoChunks, message=TRUE, results='asis'}
```
