...
read_chunk("./reports/seeds-gait/seed-study.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r lasa, echo=echoChunks, results='asis', message=FALSE}
```
