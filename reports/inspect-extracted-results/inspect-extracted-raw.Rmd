---
title: Inspect extracted results
output:
  html_document:
    keep_md: yes
    toc: yes
...
read_chunk("./reports/inspect-extracted-results/inspect-extracted-raw.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r prep-for-basic-view, echo=echoChunks, results='hid', message=FALSE}
```


```{r basic-view, echo=echoChunks, results='show', message=FALSE}
```
