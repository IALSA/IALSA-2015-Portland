...
read_chunk("./reports/outcome-space/outcome-space.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r outcome-space-map, echo=echoChunks, results='show', message=FALSE, warning=FALSE, fig.width=15, fig.height=10, dpi=300}
# 
...
![prototype](./sandbox/model_space_new/docs/Piccinin_Cognitive_Domains.PNG)  
