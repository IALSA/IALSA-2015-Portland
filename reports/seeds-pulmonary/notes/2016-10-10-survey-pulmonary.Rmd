...
read_chunk("./reports/seeds-pulmonary/notes/2016-10-10-survey-pulmonary.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r content, echo=TRUE, results='show', message=FALSE, warning = FALSE}
```
