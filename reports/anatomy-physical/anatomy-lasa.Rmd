...
read_chunk("./reports/anatomy-physical/model-anatomy-physical.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r lasa, echo=echoChunks, results='asis', message=FALSE, warning=FALSE}
```
