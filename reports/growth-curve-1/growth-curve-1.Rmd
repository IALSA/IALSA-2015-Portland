...
read_chunk("./reports/growth-curve-1/growth-curve-1.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r table-dynamic-collapsed, echo=echoChunks, message=TRUE}
```
