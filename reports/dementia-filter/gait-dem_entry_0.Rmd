---
title: 'OCTO : Seed Report (dem_entry_0)'
output:
  html_document:
...
|condition  | dementia_entry| dementia_ever|   n|
|:--|--------------:|-------------:|---:|
|dem_ever_0 |              0|             0| 477|
|dem_entry_0  |              0|             1| 126|
|all  |              1|             1|  98|
...
read_chunk("./reports/dementia-filter/seed-study.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r select-condition, echo=echoChunks, results='show', message=FALSE}
# selected_condition <- "dem_ever_0"
selected_condition <- "dem_entry_0"
# selected_condition <- "all"
```

```{r subset-condition, echo=echoChunks, results='show', message=FALSE}
```
