...
read_chunk("./reports/overlap_search_graphs/table_2.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r table_2, echo=echoChunks, results='show', message=FALSE, warning=FALSE, fig.width=15, fig.height=10, dpi=300}
domain_map(dsb)
```
