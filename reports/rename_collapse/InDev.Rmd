---
title: "Pivot Tables: IALSA Portland 2015"
output:
  html_document:
...
read_chunk("./reports/rename_collapse/InDev.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r ptable_1, echo=echoChunks, results='show', message=FALSE, warning=FALSE}
```

## pivot table 2
```{r ptable_2, echo=echoChunks, results='show', message=FALSE, warning=FALSE}
```
