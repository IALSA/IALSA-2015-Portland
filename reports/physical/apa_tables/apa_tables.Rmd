...
**Note 1**: The current report covers `r nrow(ds_wide)` models, with `r length(unique(ds_wide$study_name))` unique studies.


```{r assemble_table, echo=echoChunks, results='show', message=FALSE}
```
