...
8. Run models
   There are just a few models in each study that needs to be run, so we list them all here, grouped by study. You can use this list as your TODO list for estimation:
